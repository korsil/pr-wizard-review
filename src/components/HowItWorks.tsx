  ...
  const steps = [
    {
      ...
      description:
        "Install our package via npm or use our GitHub app for instant setup.",
      code: installCode,
    },
    {
      number: "02",
      ...
      description:
        "Set your preferences to match your team's coding standards.",
      code: configCode,
    },
    {
      number: "03",
      ...
      description:
        "PRWizard analyzes every new pull request and adds comments inline.",
      code: null,
    },
    {
      number: "04",
      ...
      description:
        "Our AI learns from your feedback and improves with every review.",
      code: null,
    },
  ];
      ...
      >
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-600">
            PRWizard integrates seamlessly into your workflow, providing value
        ...
        <div ref={stepsRef} className="space-y-16 md:space-y-24">
          {steps.map((step, index) => (
            <div
              key={index}
              className={`step opacity-0 translate-y-10 transition-all duration-700 delay-${
                index * 200
              }`}
            >
              <div
              ...
              >
                <div className="md:w-1/2 md:px-6">
                  <div className="mb-4">
                    <span className="text-xs font-semibold text-prWizard-purple">
                      STEP
                    </span>
                    <span className="text-2xl md:text-3xl font-bold ml-2 text-prWizard-purple">
                      {step.number}
                    </span>
                  </div>
                    ...
                    <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg border border-gray-100">
                      <div className="aspect-w-16 aspect-h-9 bg-gray-100 rounded-md mb-4">
                        <div className="flex items-center justify-center h-full bg-prWizard-dark rounded-md">
                          <div className="text-5xl text-prWizard-purple">
                            {step.number === "03" ? "🔍" : "🧠"}
                          </div>
                        </div>
                      </div>
                      <div
                        className={`h-4 bg-gray-200 rounded-full mb-3 overflow-hidden ${
                          step.number === "03" ? "w-3/4" : "w-full"
                        }`}
                      >
                        <div
                          className="h-full bg-gradient-to-r from-prWizard-darkPurple to-prWizard-purple"
                          style={{
                            width: step.number === "03" ? "75%" : "90%",
                          }}
                        ></div>
                      </div>
